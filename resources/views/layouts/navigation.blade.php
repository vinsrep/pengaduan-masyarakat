        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        <x-nav-link :href="route('staff.dashboard')" :active="request()->routeIs('admin.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                        <x-nav-link :href="route('staff.posts.index')" :active="request()->routeIs('staff.posts.index')">
                            {{ __('Posts') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.provinces.index')" :active="request()->routeIs('admin.provinces.index')">
                    {{ __('Provinces') }}
                </x-responsive-nav-link>
            @else
                ...
                <x-responsive-nav-link :href="route('staff.posts.index')" :active="request()->routeIs('staff.posts.index')">
                    {{ __('Posts') }}
                </x-responsive-nav-link>
            @endif
        </div>

    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden max-w-4xl mx-auto">
        <div class="flex justify-between items-center bg-gray-50 px-6 py-3">
            <div class="flex items-center space-x-4">
                <a href="{{ route('staff.posts.index') }}" class="text-blue-500 hover:underline">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('staff.posts.edit', $post->id) }}" class="bg-blue-500 text-white px-4 py-1 rounded hover:bg-blue-600">
                    Edit Post
                </a>
                <form action="{{ route('staff.posts.destroy', $post->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this post?');">
                    @csrf
                    @method('DELETE')
        ...
        <div class="p-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg mb-6">
                ...
                <form action="{{ route('staff.posts.update-status', $post->id) }}" method="POST">
                    @csrf
                    @method('POST')
            ...
            <div class="mt-8">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            <div class="flex justify-between">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <form action="{{ route('staff.comments.destroy', $comment->id) }}" method="POST"
                ...
                <div class="mt-6 border-t border-gray-200 pt-6">
                    <h3 class="text-lg font-medium mb-3">Add staff Comment</h3>
                    <form action="{{ route('staff.comments.store') }}" method="POST">
                        @csrf
